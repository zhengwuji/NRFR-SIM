...
// 版本单源:从根目录 gradle.properties 读取 APP_VERSION_CODE / APP_VERSION_NAME
...
// release 签名:存在 keystore.properties 时使用正式签名,否则回退 debug 签名,
// 保证 assembleRelease 在任何环境都能产出可安装、可升级的 APK。
...
dependencies {
    ...
    // Shizuku(13.1.5 仍为最新稳定版,已验证支持 Android 16)
